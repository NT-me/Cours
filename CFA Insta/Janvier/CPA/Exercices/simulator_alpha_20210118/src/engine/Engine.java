...
public class Engine implements EngineService, RequireDataService, RequireAlgorithmService{
  ...
  public void moveLeft(){
    //if (data.getHeroesPosition().x>0) data.setHeroesPosition(new Position(data.getHeroesPosition().x-1,data.getHeroesPosition().y));
  ...
  public void moveOtherLeft(){
    data.setOtherPosition(new Position(data.getOtherPosition().x-1, data.getOtherPosition().y));
  }
  ...
  public void moveOtherUp(){
    data.setOtherPosition(new Position(data.getOtherPosition().x, data.getOtherPosition().y-1));
