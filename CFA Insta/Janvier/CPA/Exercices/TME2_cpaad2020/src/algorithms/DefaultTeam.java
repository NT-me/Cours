...
------------------------------------------------------------------------------*/
  ...
  public Circle calculCercleMin(ArrayList<Point> points) {
    ...
    Line diametre = diametreCercleMin(points_);
  ...
  public ArrayList<Point> CalculGraham(ArrayList<Point> points){
  ...
  public ArrayList<Point> enveloppeConvexe(ArrayList<Point> points){
    ...
    points = algoNaif(algoAklToussaint(points));
    System.out.println(points.size());
    ...
    // points = filtrageJarvis(points);
      ...
      Point NO = new Point(ouest.x, nord.y);
      Point SO = new Point(ouest.x, sud.y);
      Point NE = new Point(est.x, nord.y);
      Point SE = new Point(est.x, sud.y);
      ArrayList<Point> res = new ArrayList<Point>();
      res.add(NO);
      res.add(SO);
      res.add(SE);
